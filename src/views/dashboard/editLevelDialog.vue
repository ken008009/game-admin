<template>
  ...
  >
    <div class="cont-menu">
      ...
      <el-input v-model="vip" type="number" class="input-desc" placeholder="请输入" />
    </div>
...
<script>
import { setLevel } from '@/api/orderModel'
const default_form = {
  address: ''
}
export default {
  ...
  methods: {
    ...
    add: async function(vip) {
      this.isLoading = true
      const address = this.address
      let res = res = await setLevel({ address, vip: vip })
